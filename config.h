...
static const char col_gray2[] = "#232A2E";
// font color
...
static const char *ranger[] = {"kitty", "-e", "ranger"};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_b, spawn, {.v = blender}},
